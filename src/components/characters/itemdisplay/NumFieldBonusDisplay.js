...
export default function NumFieldBonusDisplay(props) {
    ...
    function treatBonusPosition() {
        switch(options.bonusposition) {
            case "BOTTOM":
                return(
                    <div class="d-flex flex-column align-items-center">
                        <input class="form-control numfield" value={value} onChange={event => processValue(event.target.value, secondary)}/>
                        <input class="form-control tiny-input" value={secondary} onChange={event => processValue(value, event.target.value)}/>   
                    </div>
                )
            case "RIGHT":
                return(
                    <div class="d-flex flex-row align-items-center">
                        <input class="form-control numfield" value={value} onChange={event => processValue(event.target.value, secondary)}/>
                        <input class="form-control tiny-input-right" value={secondary} onChange={event => processValue(value, event.target.value)}/>   
                    </div>
                )
            default:
                break
