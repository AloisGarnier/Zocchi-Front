            ...
            case "TOP":
                return(
                    <div class="d-flex flex-column align-items-center m-2">
                        ...
                        <textarea class="form-control largetextfieldmovable" value={value} onChange={event => processValue(event.target.value)}/>
                    </div>
                )
            case "LEFT":
                return(
                    <div class="d-flex flex-row align-items-center m-2">
                        ...
                        <textarea class="form-control largetextfieldmovable mx-1" value={value} onChange={event => processValue(event.target.value)}/>
                    </div>
                )
            default:
                break
