                ...
                <div class="card-body">
                    ...
                    <h4 class="my-title d-flex justify-content-center">1. Présentation du site</h4>
                        <p class="justify-content-start text-align-justify margin-x">
                            ...
                            il est précisé aux utilisateurs du site bieresetpizzas.fr l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi :<br />
                            <ul>
                                <li>
                                    Propriétaire du site, responsable de la conception et du développement : Aloïs Garnier - 85 avenue André Morizet, 92100 Boulogne-Billancourt
                                </li>
                                <li>
                        ...
                        <p class="justify-content-start text-align-justify margin-x">    
                            Les utilisateurs du site bieresetpizzas.fr acceptent pleinement et entièrement les conditions générales d'utilisation décrites ci-après.
                            Ces conditions d'utilisation pouvant être modifiées ou complétées à tout moment, les utilisateurs du site bieresetpizzas.fr sont donc invités à les consulter de manière régulière.
                        </p>
                        <p class="justify-content-start text-align-justify margin-x"> 
                        ...
                        <p class="justify-content-start text-align-justify margin-x"> 
                            Le site bieresetpizzas.fr a pour objet de présenter l'ensemble des activités de la société, et tout particulièrement la vente d'objets décoratifs.
                        </p>
                        <p class="justify-content-start text-align-justify margin-x"> 
                        ...
                        <p class="justify-content-start text-align-justify margin-x">
                            Le site bieresetpizzas.fr utilise les technologies Java et JavaScript.
                        </p>
                        <p class="justify-content-start text-align-justify margin-x">
                        ...
                        <p class="justify-content-start text-align-justify margin-x">
                            Aloïs Garnier est, sauf mention contraire, propriétaire de l'intégralité des droits d'auteur et droits voisins afférant à tous les éléments accessibles sur le site,
                            notamment les textes, images, graphismes, logiciels, etc.
                        </p>
                        <p class="justify-content-start text-align-justify margin-x">
                            Par conséquent, toute utilisation, reproduction ou modification de tout ou partie des éléments du site, par quelque moyen que ce soit, est interdite, sauf autorisation préalable de la part d'Aloïs Garnier.
                        </p>
                        <p class="justify-content-start text-align-justify margin-x">
                        ...
                        <p class="justify-content-start text-align-justify margin-x">
                            Aloïs Garnier ne pourra être tenue pour responsable des dommages directs ou indirects causés au matériel de l'utilisateur lors de l'accès au site bieresetpizzas.fr,
                            résultant soit de l'utilisation de matériel incompatible, soit de l'apparition d'un problème technique.      
                        </p>
                        <p class="justify-content-start text-align-justify margin-x">
                            En outre, Aloïs Garnier ne pourra être tenue pour responsable des dommages indirects (par exemple, une perte de marché ou une perte de chance) consécutifs à l'utilisation du site.
                        </p>
                        <p class="justify-content-start text-align-justify margin-x">
                            Au sein des espaces interactifs (messagerie, commentaires, etc.), Aloïs Garnier se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu qui contreviendrait à la législation applicable en France,
                        ...
                        <p class="justify-content-start text-align-justify margin-x">
                            Le site bieresetpizzas.fr contient un certain nombre de liens hypertextes vers d'autres sites, mis en place avec l'autorisation de la part d'Aloïs Garnier. Cependant, n'ayant pas la possibilité de vérifier le contenu des sites ainsi visités, elle n'assumera aucune responsabilité de ce fait.
                        </p>

                        <h4 class="my-title d-flex justify-content-center">9. Traceurs et cookies</h4>
                        <p class="justify-content-start text-align-justify margin-x">
                            La navigation sur le site bieresetpizzas.fr est susceptible de provoquer l'utilisation et l'installation de traceurs (cookies, stockage local, etc.) sur l'ordinateur de l'utilisateur. 
                        </p>
                        <p class="justify-content-start text-align-justify margin-x">
